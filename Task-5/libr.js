...
function formSubmit(e) {
  ...
  let checknature= document.getElementById("Nature");
  let checkhistory = document.getElementById("History");
  if (checkFiction.checked) {
    givenType = checkFiction.value;
  } else if (checkPrograming.checked) {
    givenType = checkPrograming.value;
  }
   else if (checkhistory.checked) {
    givenType = checkhistory.value;
  }   
    
    
  else if (checknature.checked) {
    givenType = checknature.value;
  }
 else {
